"""
Model Catalogue - Manages available models with online/offline support.
...
class ModelInfo:
    ...
    category: str = "general"  # general, coding, multilingual, etc.
    context_length: int = 4096
    parameters: str = "7B"
    quantization: str = "Q4_K_M"
    is_local: bool = False  # True if model is already downloaded
...
DEFAULT_MODELS: List[ModelInfo] = [
    ...
    ModelInfo(
        ...
        recommended=False,
        speed="Very Fast (~30 tok/sec)",
        quality="Good",
        requirements="4GB RAM, 3GB disk",
        ollama_name="llama3.2:3b-instruct-q4_K_M",
        huggingface_url="https://huggingface.co/lmstudio-community/Llama-3.2-3B-Instruct-GGUF/resolve/main/Llama-3.2-3B-Instruct-Q4_K_M.gguf",
        category="general",
        context_length=8192,
        parameters="3B",
    ),
    ModelInfo(
        ...
        size_gb=4.1,
        description="Excellent for technical and coding tasks",
        recommended=False,
        speed="Fast (~22 tok/sec)",
        quality="High",
        requirements="8GB RAM, 5GB disk",
        ollama_name="mistral:7b-instruct-q4_K_M",
        huggingface_url="https://huggingface.co/TheBloke/Mistral-7B-Instruct-v0.2-GGUF/resolve/main/mistral-7b-instruct-v0.2.Q4_K_M.gguf",
        category="coding",
        context_length=8192,
        parameters="7B",
    ),
    ModelInfo(
        ...
        recommended=False,
        speed="Very Fast (~35 tok/sec)",
        quality="Good",
        requirements="4GB RAM, 3GB disk",
        ollama_name="phi3:mini",
        huggingface_url="https://huggingface.co/microsoft/Phi-3-mini-4k-instruct-gguf/resolve/main/Phi-3-mini-4k-instruct-q4.gguf",
        category="general",
        context_length=4096,
        parameters="3.8B",
    ),
    ModelInfo(
        ...
        quality="High",
        requirements="8GB RAM, 5GB disk",
        ollama_name="codellama:7b-instruct-q4_K_M",
        huggingface_url="https://huggingface.co/TheBloke/CodeLlama-7B-Instruct-GGUF/resolve/main/codellama-7b-instruct.Q4_K_M.gguf",
        category="coding",
    ...
    ModelInfo(
        ...
        recommended=False,
        speed="Fast (~18 tok/sec)",
        quality="Very High",
        requirements="12GB RAM, 6GB disk",
        ollama_name="gemma2:9b-instruct-q4_K_M",
        huggingface_url="https://huggingface.co/bartowski/gemma-2-9b-it-GGUF/resolve/main/gemma-2-9b-it-Q4_K_M.gguf",
        category="general",
        context_length=8192,
        parameters="9B",
    ),
...
class ModelCatalogue:
    ...
    Features:
    - Fetches latest models from HuggingFace when online
    - Falls back to bundled catalog when offline
    - Caches online results for 24 hours
    - Detects locally installed models
    """
    ...
    def get_local_models(self) -> List[ModelInfo]:
        ...
        if llm_dir.exists():
            for file in llm_dir.glob("*.gguf"):
                ...
                if matched_model:
                    # Create a copy with is_local=True
